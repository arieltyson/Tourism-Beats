...
struct CitySearchOverlay: View {
    ...
    var body: some View {
        ...
        .animation(.spring(response: 0.3, dampingFraction: 0.7), value: searchResults.count)
    }
    ...
    private func performSearch(_ query: String) {
        ...
        if query.isEmpty {
            ...
            .sorted { city1, city2 in
                ...
                let city1NameMatch = city1.name.localizedCaseInsensitiveContains(query)
                let city2NameMatch = city2.name.localizedCaseInsensitiveContains(query)
    ...
    private func highlightedText(_ text: String, searchText: String) -> AttributedString {
        ...
        if !searchText.isEmpty {
            ...
            for range in ranges {
                ...
                attributedString[attributedRange].backgroundColor = .blue.opacity(0.3)
    ...
    CitySearchOverlay(
        ...
        cities: [
            ...
            CityModel(
                id: "2",
                name: "New York",
                country: CountryModel(name: "United States", code: "US", flag: "🇺🇸"),
                imageName: "newyork",
